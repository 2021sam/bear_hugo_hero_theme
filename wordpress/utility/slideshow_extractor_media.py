# /Users/2021sam/apps/BEAR/hugo/05_05_wp_conv/bear/wordpress/utility/slideshow_extractor_media.py
...
html_file = os.path.join(os.path.dirname(__file__), "..", "html", "media-sandblasting.html")
html_file = os.path.abspath(html_file)  # resolves ".." to absolute path

url_page = "media-sandblasting"               # Used for directory: static/{url_page}/slider_#
